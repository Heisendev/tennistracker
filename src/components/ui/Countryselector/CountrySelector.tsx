    ...
    <div ref={ref}>
      <div className="mt-1 relative">
        <button
          ...
          } relative w-full border border-gray-300 shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm`}
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.ul
              ...
              className="absolute pl-1 z-10 mt-1 w-full bg-white shadow-lg max-h-90 rounded-md text-base ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
              tabIndex={-1}
              role="listbox"
              aria-labelledby="listbox-label"
